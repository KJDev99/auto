...
const BestDeals = () => {
  ...
  return (
    <>
      <div className="md:container relative max-md:hidden">
      ...
      <div className="grid grid-cols-3 gap-6 max-md:grid-cols-1 max-md:flex max-md:overflow-x-auto max-md:gap-[10px]  custom-scrollbar md:hidden max-md:mb-[60px]">
        {cardCarData.map((car, index) => (
          <Link href={`/katalog/${car.id}`} key={index} className="max-md:w-full max-md:flex-shrink-0">
            <CardCar {...car} />
          </Link>
        ))}
      </div>
